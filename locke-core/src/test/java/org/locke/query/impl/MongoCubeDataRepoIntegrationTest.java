...
public class MongoCubeDataRepoIntegrationTest extends IntegrationTestCase {
    ...
    public void setUp() throws Exception {
        ...
        try {
            col = IntegrationTestCase.mongoDB.createCollection("test_cube", new BasicDBObject());
        } catch (CommandFailureException e) {
            col = IntegrationTestCase.mongoDB.getCollection("test_cube");
        }
    ...
    public void testQuery() throws Exception {
        ...
        DataNode ret = cubeDataRepo.query("test_cube", "test_aggregate", new SimpleCondition());
        assertNotNull(ret);
    }
