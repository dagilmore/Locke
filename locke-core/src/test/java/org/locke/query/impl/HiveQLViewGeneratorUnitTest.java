...
public class HiveQLViewGeneratorUnitTest {
    ...
    public void testCreateView__NestedSelectWithFunctions() throws Exception {
        ...
        where.and(new SimpleCondition("test_subquery", "name", "tom", Comparator.EQ));
        where.and(new SimpleCondition("test_subquery", "type", "person", Comparator.EQ));
    ...
    public void testCreateView__SelectWithJoin() throws Exception {
        ...
        selectView.setColumns(columns);
            ...
            SimpleCondition on = new SimpleCondition("", "cid", "opensecrets_id", Comparator.EQ);

            SimpleCondition where = new SimpleCondition("", "cid", "'24K'", Comparator.EQ);
            ...
            on = new SimpleCondition("", "recip_id", "opensecrets_id", Comparator.EQ);
        ...
        on = new SimpleCondition("", "cid", "opensecrets_id", Comparator.EQ);

        where = new SimpleCondition("", "cid", "'24K'", Comparator.EQ);
